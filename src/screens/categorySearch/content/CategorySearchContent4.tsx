...
type NavigationProp = StackNavigationProp<RootStackParamList, 'BookSearch4'>;

export default function CategorySearchContent4() {
  const navigation = useNavigation<NavigationProp>();

  return (
    <>
      <TouchableOpacity onPress={() => navigation.navigate('BookSearch4')}>
        <BooklistWrapper>
          <BookImage
          ...
          <BookContainer>
            ...
            <BookPublisher>blackD(블랙디) / 2022</BookPublisher>
            <CategoryWrapper>
              <CategoryUserImage
